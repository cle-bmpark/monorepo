...
import Calendar, { DateRange } from '@repo/ui/src/components/headless/Calendar';
...
export default function CalendarView() {
  ...
  return (
    <div className='flex flex-col gap-4'>
      {/* Calendar */}
      <h2>Calendar</h2>
      <div className='border-grey-300 flex flex-col flex-wrap gap-12 rounded-s-lg border-1 p-4'>
        <p>
