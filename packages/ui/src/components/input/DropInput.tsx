...
export default function DropInput<T>({
  ...
  return (
    <div className='relative flex flex-1 flex-col gap-1' ref={dropdownRef}>
      ...
      >
        <input
          className={`text-16 flex min-w-0 flex-1 outline-0 ${variantStyle[variantKey].input}`}
      ...
      {isOpen && (
        <div className='border-grey-300 bg-grey-0 shadow-strong absolute top-[80%] left-0 z-10 max-h-48 w-[100%] overflow-auto rounded-sm border p-1'>
