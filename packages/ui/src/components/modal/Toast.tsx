...
export default function Toast() {
  ...
  return (
    <div className='fixed top-0 right-0 bottom-0 left-0 z-20'>
      ...
      >
        <div
          className={`flex max-w-3xl items-center justify-between gap-2 rounded-lg px-4 py-3.5 shadow-light ${toast.width ?? 'min-w-96'} ${variantStyle[toast.style ?? 'dark'].wrapper}`}
        >
