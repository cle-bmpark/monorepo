...
export default function Tooltip({
  ...
  return (
    <div className='flex flex-col items-center'>
      ...
      {isTriangle && (
        <div
          className={`shadow-strong h-0 w-0 border-t-[12px] border-r-[8px] border-b-0 border-l-[8px] border-solid border-r-transparent border-b-transparent border-l-transparent ${variantStyle[style].triangle}`}
        />
      )}
    </div>
  );
